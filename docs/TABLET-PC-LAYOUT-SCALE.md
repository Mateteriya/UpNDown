...
**Все визуальные настройки планшет-версии стола** (Север `top: 25px`, сукно «100%» = бывший 125%-look, шкала 93–108%, зазоры Запад/Восток при 107–108%, подъём стола +5px и т.д.) снимались и принимались на экране:
...
- Шестерёнка карт руки (PC hand scale); 4p UI **94–106%** (новая «100%» = середина 98…112 abs ≈105%; шаг 1%).

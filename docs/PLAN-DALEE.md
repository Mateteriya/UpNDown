...
## 5. Архив результатов и статистика — **в работе**

- [x] При `game-complete` (офлайн) писать срез итога в `partyHistory` по `profileId` (очки, место, фишки, режим; до 40 записей).
- [x] «Ваш рейтинг» — блок «Последние офлайн-партии».
- [ ] Полный срез с `dealHistory` / экран «Мои партии»; IndexedDB при росте объёма.
...
| 5 | Архив результатов, история в «Ваш рейтинг» | В работе (офлайн-итоги) |

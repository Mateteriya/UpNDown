...
- **Персональный ИИ (концепт):** изучение стиля игрока по заказам/ходам/аналитике и формирование промпта (профиля) для заменяющего ИИ во время пауз/отсутствий — см. [PERSONAL-AI-CONCEPT.md](./PERSONAL-AI-CONCEPT.md).

...
> **Статус (2026-06):** сервер **реализован** (протокол v2, ветка `feat/lan-server-v2`).  
> Актуальные инструкции:
> - [LAN-SERVER-V2-WORKFLOW.md](./LAN-SERVER-V2-WORKFLOW.md) — порядок работ
> - [TECH-DIRECTOR-ONLINE-SERVER.md](./TECH-DIRECTOR-ONLINE-SERVER.md) — VPS для техдиректора
> - [server/README.md](../server/README.md) — локальный запуск
>
> Ниже — **исторический** план; чеклисты «сервер не реализован» устарели.
...
### Чеклист для МЕНЯ (реализация) — выполнено в v2

- [x] Игровой сервер v2: команды, `GameSession`, таймеры, `AiDriver`
- [x] Протокол: [LAN-SERVER-V2-RFC.md](./LAN-SERVER-V2-RFC.md)
- [x] Фронт: `OnlineGameContextV2`, `isServerAuthoritativeOnline()`
- [x] [server/README.md](../server/README.md)
- [x] Шаблон Dockerfile в [TECH-DIRECTOR-ONLINE-SERVER.md](./TECH-DIRECTOR-ONLINE-SERVER.md)

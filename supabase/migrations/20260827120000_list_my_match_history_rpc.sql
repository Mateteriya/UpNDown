-- Лента «Мои партии» по аккаунту: security definer, без RLS-join PostgREST.
-- Elo уже пишется в player_ratings; список читался прямым select+inner join и часто приходил пустым.

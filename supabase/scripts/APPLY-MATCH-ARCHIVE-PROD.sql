-- APPLY-MATCH-ARCHIVE-PROD.sql
-- Production: run in Supabase SQL Editor after review (staging first).
-- Adds matches.deal_history, chips in finish_game / record_offline_match RPCs.
--
